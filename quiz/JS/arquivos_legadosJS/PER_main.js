...
function populate(){
    if(quiz.acabado()){
        var elemRecord = document.getElementById("Quiz");
	elemRecord.innerHTML = "o quiz acabou, seu record foi " + quiz.record.text;
    }
    else{
        //Mostra as questões
        var elementoQuestao = document.getElementById("question"); //pega o id "questoes" do arquivo index.html
        ...
        for(var i = 0; i < escolhas; i++){
            var elemento = document.getElementById("choices" + i);
